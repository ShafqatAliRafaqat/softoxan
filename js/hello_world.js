	;(function(main) {
		...
		txtCtx.font = 'bold 80px Montserrat';
		txtCtx.textAlign = 'center';
		txtCtx.baseline = 'middle';
		txtCtx.fillText('H E L L O ', WIDTH / 2, HEIGHT / 2);
		txtCtx.fillText('W O R L D ', WIDTH / 2, HEIGHT / 2 + 100);
		...
		requestAnimationFrame(function loop() {
			...
			ctx.fillStyle = 'white';
			ctx.fillText('CLICK TO TOGGLE', WIDTH / 2, HEIGHT / 2 + 150);					
